...
class Ui {
    ...
    logoutProcess() {
       let get=(async(url)=>(await fetch(url)).json())
        get("http://eraftek.appspot.com/api/auth/logout")
        .then(res=>{
            if (res.success) {
                afterLoginMenu.innerHTML = ""
    ...
    sendCardToUI(res){
        res.data.forEach(element => {
            ...
            <div class="col">
            <div class="card">
              <a href="eraftek.appspot.com.com"> <img src="public/upload/${element.profile_image}" class="card-img-top" alt="zzz"></a>
              <div class="card-body">
                <a href="eraftek.appspot.com.com" class="text-decoration-none"><h5 class="card-title">${element.name}</h5></a></a>
